...
const REDIRECT_TARGET = "/customer/checkout";

/**
 * The cart page's "Proceed to Checkout" button. Shared by both
 * components/customer/cart-view.tsx (mock) and live-cart-view.tsx (real
 * backend cart) since the guest-vs-signed-in decision is identical either
 * way. A signed-in customer or vendor (isAuthenticated, from the server —
 * app/customer/cart/page.tsx's verifySession()) goes straight to checkout, same
 ...
 * carry `?redirect=/customer/checkout` (login-form.tsx / register-form.tsx read
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-ink/40 p-4">
          <div className="w-full max-w-sm rounded-2xl bg-white p-6 shadow-xl">
            ...
            <div className="mt-6 space-y-2">
              ...
              <Link
                href={`/register/customer?redirect=${encodeURIComponent(REDIRECT_TARGET)}`}
